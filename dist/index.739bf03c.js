...
var _fetchImagesDefault = parcelHelpers.interopDefault(_fetchImages);
var _renderCardImg = require("./renderCardImg");
var _renderCardImgDefault = parcelHelpers.interopDefault(_renderCardImg);
var _checkAnswer = require("./checkAnswer");
var _checkAnswerDefault = parcelHelpers.interopDefault(_checkAnswer);
...
let value = null;
let currentPage = 1;
inputEl.addEventListener("input", (0, _lodash.debounce)(inputData, DEBOUNCE_DELAY));
...
function submitBtn(event) {
    ...
    if (!value) {
        ...
        galleryEl.innerHTML = "";
        (0, _fetchImagesDefault.default)(value, currentPage).then((0, _checkAnswerDefault.default)).catch((error)=>console.log(error));
    }
}
async function addPage() {
    currentPage += 1;
    (0, _fetchImagesDefault.default)(value, currentPage).then(loadMore).catch((error)=>console.log(error));
}
...
function loadMore(responce) {
    ...
    (0, _renderCardImgDefault.default)(totalImg);
    endScroll(galleryEl);
}
...
},{"./fetchImages":"dOg5x","./renderCardImg":"d1Dza","./checkAnswer":"7M5kv","notiflix":"5WWYd","axios":"jo6P5","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dOg5x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
// };
const fetchImages = async (value, page)=>{
    const response = await axios.get(`https://pixabay.com/api/?key=29203601-a0eb79026b7a5f5129e46889e&q=${value}&image_type=photo&orientation=horizontal&safesearch=true&per_page=40&page=${page}`);
    return response;
};
...
},{}],"d1Dza":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _notiflix = require("notiflix");
var _notiflixDefault = parcelHelpers.interopDefault(_notiflix);
...
function renderCard(arr) {
    const markup = arr.map(({ largeImageURL , webformatURL , tags , likes , views , comments , downloads ,  })=>`<a href="${largeImageURL}"> <div class='photo-card'>
  ...
  <div class='info'>
    ...
    let simplelightbox = new (0, _simplelightboxDefault.default)(".photo-card a", {
        captionsData: "alt",
...
},{"notiflix":"5WWYd","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"kaxSc":[function() {},{}],"7M5kv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _notiflix = require("notiflix");
var _notiflixDefault = parcelHelpers.interopDefault(_notiflix);
...
function checkAnswer(responce) {
    ...
    if (currentHits.length !== 0) {
        ...
        (0, _renderCardImgDefault.default)(currentHits);
    } else {
        galleryEl.innerHTML = "";
        (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
    }
...
function checkImgQuantity(responce) {
    ...
    if (dataTotalHits > photoPerPage) loadMoreBtnEl.classList.remove("is-hidden");
    else loadMoreBtnEl.classList.add("is-hidden");
}
exports.default = checkAnswer;

},{"notiflix":"5WWYd","./renderCardImg":"d1Dza","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kaxSc":[function() {},{}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
